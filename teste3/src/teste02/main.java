...
public class Main {
	...
	private static List<Usuario> criarUsuarios() {
	    // Crie e retorne uma lista de usuários aqui
	}

	private static List<Cliente> criarClientes() {
	    // Crie e retorne uma lista de clientes aqui
	}

	private static List<Empresa> criarEmpresas() {
	    // Crie e retorne uma lista de empresas aqui
	}

	private static List<Produto> criarProdutos() {
	    // Crie e retorne uma lista de produtos aqui
	}
